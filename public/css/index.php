        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><b>LES MEMBRES</b></h2>
                        ...
                        <div class="wow-pricing featured">
                            <div class="wow-pricing-header">
                                ...
                                <div class="wow-pricing-per">
                                    <?php if (isset($user->SPECIALITY)) echo htmlspecialchars($user->SPECIALITY, ENT_QUOTES, 'UTF-8'); ?>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer" >
                                                <div class="col-md-12 text-center">
                                                    <a href="<?php echo URL . 'users/editUser/' . htmlspecialchars($user->ID, ENT_QUOTES, 'UTF-8'); ?>"
